...
function ENT:SetPackedRatio(idx,value)
	self:SetNWFloat(Format("F%s",idx),math.Round(value,3))
end

function ENT:GetPackedRatio(idx)
	return self:GetNWFloat(Format("F%s",idx))
end
...
function ENT:SetPackedBool(idx,value)
	self:SetNWBool(Format("B%s",idx),value)
end

function ENT:GetPackedBool(idx)
	return self:GetNWBool(Format("B%s",idx))
end