...
function ENT:Draw()
	...
	cam.Start3D2D(pos, ang, 1/16)
		...
		surface.DrawRect(20, 32+64*0, 192-48, 32)
		surface.DrawRect(20, 32+64*1, 192-48, 32)
		surface.DrawRect(20, 32+64*2, 192-48, 32)
		surface.DrawRect(20, 32+64*3, 192-48, 32)
		surface.DrawRect(20, 32+64*4, 192-48, 32)
		
		draw.DrawText(Format("%08.0f",self:GetTotal()*1000),"MetrostroiSubway_IGLA",20+4,32+64*0,Color(255,255,255,255))
		--draw.DrawText(",","MetrostroiSubway_IGLA",20+4+26,32+64*0,Color(255,255,255,255))
		draw.DrawText(".","MetrostroiSubway_IGLA",20+4+64+7,32+64*0+1,Color(255,255,255,255))
		draw.DrawText("E (watts-hour)","MetrostroiSubway_VerySmallText3",16,8+64*0,Color(0,0,0,255))
		
		draw.DrawText(Format("%08.1f",self:GetRate()*1e-3),"MetrostroiSubway_IGLA",20+4,32+64*1,Color(255,255,255,255))
		draw.DrawText("P (kW)","MetrostroiSubway_VerySmallText3",16,8+64*1,Color(0,0,0,255))
		
		draw.DrawText(Format("%8.2f",Metrostroi.GetEnergyCost(self:GetTotal())),"MetrostroiSubway_IGLA",20+4,32+64*2,Color(255,255,255,255))
		draw.DrawText("Cost ($)","MetrostroiSubway_VerySmallText3",16,8+64*2,Color(0,0,0,255))
		
		draw.DrawText(Format("%8.1f",self:GetV()),"MetrostroiSubway_IGLA",20+4,32+64*3,Color(255,255,255,255))
		draw.DrawText("Voltage (V)","MetrostroiSubway_VerySmallText3",16,8+64*3,Color(0,0,0,255))
		
		draw.DrawText(Format("%8.1f",self:GetA()),"MetrostroiSubway_IGLA",20+4,32+64*4,Color(255,255,255,255))
