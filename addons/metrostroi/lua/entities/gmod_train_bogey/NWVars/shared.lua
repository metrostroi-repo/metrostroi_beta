...
if SERVER then
	function ENT:SetSpeed(val)
		self:SetNWInt("Speed",math.Round(val,0.5))
	end

	function ENT:SetMotorPower(val)
		self:SetNWInt("MotorPower",math.Round(val,1.5))
	end

	function ENT:SetdPdT(val)
		self:SetNWInt("dPdT",math.Round(val,2))
	end

	function ENT:SetBrakeSqueal(val)
		self:SetNWInt("BrakeSqueal",math.Round(val,2))
	end
end
