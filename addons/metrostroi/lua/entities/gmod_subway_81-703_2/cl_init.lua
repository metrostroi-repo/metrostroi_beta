...
ENT.ClientProps["brake_disconnect"] = {
	...
	pos = Vector(450.9,-57.33,-25.61),
	ang = Angle(0,-90,0),
	color = Color(0,186,255),
}
...
ENT.ClientProps["volt1"] = {
	...
	pos = Vector(45.41455,-20.33349,19.95662),
	ang = Angle(1,0,-90)
}
...
function ENT:Think()
	...
	self:ShowHideSmooth("Blue",self:Animate("Doors_hs",self:GetPackedBool(40) and 1 or 0,0,1,5,false))
