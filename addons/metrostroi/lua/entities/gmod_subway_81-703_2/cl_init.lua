...
ENT.ClientProps["Ema_salon"] = {
	model = "models/metrostroi_train/81-703/81-703_salon_interim.mdl",
	pos = Vector(0,0,0),
	ang = Angle(0,0,0)
}
...
function ENT:Think()
	...
	self:ShowHideSmooth("GreenRP",self:Animate("GreenRP_hs",self:GetPackedBool(36) and 1 or 0,0,1,4,false))
	self:ShowHideSmooth("RedRP",self:Animate("RedRP_hs",self:GetPackedBool(35) and 1 or 0,0,0.6,2.5,false) + self:Animate("RedLSN_hs",self:GetPackedBool(131) and 1 or 0,0,0.4,5,false))
	...
	--DIP sound
	--self:SetSoundState("bpsn",self:GetPackedBool(32) and 1 or 0,1.0)
end
