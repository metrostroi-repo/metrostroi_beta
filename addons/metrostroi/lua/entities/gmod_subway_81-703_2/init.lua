...
function ENT:Initialize()
	...
	self.Lights = {
		...
		-- Interior
		[11] = { "dynamiclight",	Vector( 250, 0, 0), Angle(0,0,0), Color(230,100,30), brightness = 5, distance = 300 , fov=180,farz = 128 },
		[12] = { "dynamiclight",	Vector(   0, 0, 0), Angle(0,0,0), Color(230,100,30), brightness = 5, distance = 400, fov=180,farz = 128 },
		[13] = { "dynamiclight",	Vector(-300, 0, 0), Angle(0,0,0), Color(230,100,30), brightness = 5, distance = 400 , fov=180,farz = 128 },
