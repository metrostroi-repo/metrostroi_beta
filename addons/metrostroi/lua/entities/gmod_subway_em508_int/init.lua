...
function ENT:Initialize()
	...
	self.DriverSeat = self:CreateSeat("driver",Vector(425+5,-39,-27.5),Angle(0,0,0))
	...
	self.RearBogey  = self:CreateBogey(Vector(-320,0,-84.5),Angle(0,0,0),false)
	...
	self.Lights = {
		...
		-- Cabin
		[10] = { "dynamiclight",	Vector(435,0,20), Angle(0,-0,0), Color(219,100,71), brightness = 0.005, distance = 600, shadows = 1},

		-- Interior
		[11] = { "dynamiclight",	Vector( 300, 0, 0), Angle(0,0,0), Color(255,100,18), brightness = 6, distance = 600 , fov=180,farz = 128 },
		[12] = { "dynamiclight",	Vector(   0, 0, 0), Angle(0,0,0), Color(255,100,18), brightness = 6, distance = 400, fov=180,farz = 128 },
		[13] = { "dynamiclight",	Vector(-300, 0, 0), Angle(0,0,0), Color(255,100,18), brightness = 6, distance = 600 , fov=180,farz = 128 },
