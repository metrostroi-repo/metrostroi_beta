...
---Вагон типа Еж с АРС МП 
--------------------------------------------------------------------------------
ENT.ClientProps = {}
ENT.ButtonMap = {}

ENT.ButtonMap["Lamps"] = {
	pos = Vector(457.5,-30.9,-9.19),
	ang = Angle(0,-90,18),
	width = 315,
	height = 120,
	scale = 0.0588,
	...
	buttons = {
		----Лампы
		{ID = "RedRP",		x=44,y=34.7, radius=20, tooltip="РП: Красная лампа реле перегрузки\nRP: Red overload relay light (power circuits failed to assemble)"},
		{ID = "Sequence",		x=44+27.56,y=34.7, radius=20, tooltip="Секвенция (Контроль правильности включения аппаратов в режимах тяги и торможения при отсутствии высокого напряжения)\nSequence (Verifying the inclusion of machines in the run and braking mode when there is no high voltage)"},
		
		{ID = "VD",		x=151.5,y=100, radius=12, tooltip="ВД: Светодиод контроля выключения двигателей (ЛКВД.\nVD: The lamp of the enabling engines (indicates the presence of voltage on the 1 train conductor)"},
		{ID = "KT",		x=115.6,y=100, radius=12, tooltip="КТ: Контроль тормоза(торможение эффективно)\nKT: Brake control (efficient brakes)"},
		{ID = "AB",		x=151.5+34,y=100, radius=12, tooltip="Зеленая AБ: Следование по участку с автоблокировкой (некодируемый участок).\nAB: Work in auto-lock mode (ARS is disabled)"},
		
		{ID = "Doors",		x=230.8,y=34.6, radius=12, tooltip="Двери: Сигнализация дверей поезда\nDOORS: door state light (doors are open)"},
		{ID = "LN",			x=244.7,y=73.32, radius=12, tooltip="ЛН: Светодиод установленного направления движения для данного участка\nLED set the direction of motion for the site"},
		{ID = "Sbor",		x=230.8 + 27.6,y=34.6, radius=12, tooltip="Лампа СБОР: Ошибка сбора электрической схемы (Сигнализация неисправности)\nSBOR: Failure indicator light (power circuits failed to assemble)"},
...
ENT.ButtonMap["AVU"] = {
	pos = Vector(458.31597-0.4,-22.43482,32.93294),
...
Metrostroi.ClientPropForButton("OtklAVU",{
	...
	model = "models/metrostroi_train/Equipment/switch_2.mdl",
	ang = 180,
	z=3,
})


ENT.ButtonMap["LampsALS"] = {
	pos = Vector(457.5,-30.9,-9.19),
	ang = Angle(0,-90,0),
	width = 315,
	height = 120,
	...
	buttons = {
		----Лампы АЛС
		{ID = "L80",		x=200,  y=41, radius = 15, tooltip="80: Ограничение скорости 80 км/ч\nSpeed limit 80 kph"},
		{ID = "L70",		x=179,  y=41, radius = 15, tooltip="70: Ограничение скорости 70 км/ч\nSpeed limit 70 kph"},
		{ID = "L60",		x=157,  y=41, radius = 15, tooltip="60: Ограничение скорости 60 км/ч\nSpeed limit 60 kph"},
		{ID = "L40",		x=135,  y=41, radius = 15, tooltip="40: Ограничение скорости 40 км/ч\nSpeed limit 40 kph"},
		{ID = "L0",			x=119,  y=41, radius = 15,tooltip="0: Ограничение скорости 0 км/ч\nSpeed limit 0 kph"},
		{ID = "LNF",		x=102,  y=41, radius = 15, tooltip="ОЧ: Отсутствие частоты АРС\nNCh: No ARS frequency"},
	}
}

Metrostroi.ClientPropForButton("LNF",{
	panel = "LampsALS",
	button = "LNF",
	model = "models/metrostroi_train/81-707/ezh_lamp_och.mdl",
	ang = 90,
	z = -17,
})
...
Metrostroi.ClientPropForButton("L0",{
	panel = "LampsALS",
	button = "L0",
	model = "models/metrostroi_train/81-707/ezh_lamp_0.mdl",
	ang = 90,
	z = -17,
})
...
Metrostroi.ClientPropForButton("L40",{
	panel = "LampsALS",
	button = "L40",
	model = "models/metrostroi_train/81-707/ezh_lamp_40.mdl",
	ang = 90,
	z = -17,
})
...
Metrostroi.ClientPropForButton("L60",{
	panel = "LampsALS",
	button = "L60",
	model = "models/metrostroi_train/81-707/ezh_lamp_60.mdl",
	ang = 90,
	z = -17,
})
...
Metrostroi.ClientPropForButton("L70",{
	panel = "LampsALS",
	button = "L70",
	model = "models/metrostroi_train/81-707/ezh_lamp_70.mdl",
	ang = 90,
	z = -17,
})
...
Metrostroi.ClientPropForButton("L80",{
	panel = "LampsALS",
	button = "L80",
	model = "models/metrostroi_train/81-707/ezh_lamp_80.mdl",
	ang = 90,
	z = -17,
})
...
Metrostroi.ClientPropForButton("RedRP",{
	panel = "Lamps",
	button = "RedRP",
	model = "models/metrostroi_train/81-707/ezh_lamp_red.mdl",
})

Metrostroi.ClientPropForButton("Sequence",{
	panel = "Lamps",
	button = "Sequence",
	model = "models/metrostroi_train/81-707/ezh_lamp_green.mdl",
})

Metrostroi.ClientPropForButton("VD",{
	panel = "Lamps",
	button = "VD",
	model = "models/metrostroi_train/81-707/ezh_lamp_green.mdl",
	z = 11,
...
Metrostroi.ClientPropForButton("KT",{
	panel = "Lamps",
	button = "KT",
	model = "models/metrostroi_train/81-707/ezh_lamp_green.mdl",
	z = 11,
...
Metrostroi.ClientPropForButton("AB",{
	panel = "Lamps",
	button = "AB",
	model = "models/metrostroi_train/81-707/ezh_lamp_red.mdl",
	z = 11,
...
Metrostroi.ClientPropForButton("LN",{
	panel = "Lamps",
	button = "LN",
	model = "models/metrostroi_train/81-707/ezh_lamp_green.mdl",
	z =6,
...
Metrostroi.ClientPropForButton("Sbor",{
	panel = "Lamps",
	button = "Sbor",
	model = "models/metrostroi_train/81-707/ezh_lamp_red.mdl",
	z = 0,
...
ENT.ButtonMap["Main"] = {
	...
	buttons = {
		----Lightning
		{ID = "DIPonSet",			x=43.6, y=180, radius=20, tooltip="ВКЛ ОСВ:Включение освещения\nTurn interior lights on"},
		{ID = "DIPoffSet",		x=43.6+43*1, y=180, radius=20, tooltip="ОТКЛ ОСВ:Отключение освещения (Звонок)\nTurn interior lights off (Ring)"},
		
		----Door panel
		{ID = "KDPSet",				x=43.6+43*5, y=180, radius=20, tooltip="КДП:Правые двери\nKDP: Right doors open"},
		{ID = "KDLSet",				x=43.6+43*4, y=180, radius=20, tooltip="КДЛ: Левые дверей\nKDL: Left doors open"},
		{ID = "DoorSelectToggle",	x=43.6+43*4.5, y=180, radius=12, tooltip="Крышка выбора стороны открытия дверей\nSelect side on which doors will open"},
		{ID = "KVTSet",			x=241, y=25, radius=20, tooltip="КВТ: Кнопка восприятия торможения \nKVT"},
		
		----VUS | ALS
		{ID = "VUSToggle",		x=45.3, y=26.8, radius=20, tooltip="ФАРЫ: Включение верхних фар"},
		{ID = "ALSToggle",		x=75.7, y=26.8, radius=20, tooltip="АЛС: Включение системы автоматической локомотивной сигнализации\nALS: Automatic locomotive signalling"},
		{ID = "ALSPl",		x=75.7, y=45.8, radius=20, tooltip="АЛС Пломба\nAutomatic locomotive signalling plomb"},
		
		----PD  | ARS
		{ID = "PDToggle",		x=140, y=182, radius=20, tooltip="ПД: Тумблер переключателя дешифратора сигналов АРС (с двух- на одночастотный)\nToggle switch signal decoder"},
		{ID = "PDPl",		x=140, y=210, radius=20, tooltip="ПД пломба\nPD plomb"},
		{ID = "ARSToggle",		x=163, y=182, radius=20, tooltip="АРС: Тумблер системы автоматического регулирования скорости\nARS: Automatic speed regulation"},
		
		----Down Panel
		
		{ID = "KU1Toggle",			x=43.6,y=243,radius=20, tooltip="МК:Включение мотор-компрессора\nTurn motor-compressor on"},
		{ID = "KSNSet",				x=43.6+43*1, y=243, radius=20,  tooltip="СН:Принудительное срабатывание РП на неисправном вагоне (сигнализация неисправности)\nSN: Failure indication button"},
		{ID = "VozvratRPSet",	x=43.6+44*2, y=243, radius=20, tooltip="КУ9:Возврат РП\nReset overload relay"},
		{ID = "R_Program1Set",	x=43.6+43*3+1, y=243, radius=20, tooltip="Радиоинформатор: Программа 1\nProgram 1"},
		{ID = "VUD1Toggle",		x=43.6+43*4+1, y=243, radius=20, tooltip="КУ2: Закрытие дверей\nKU2: Door control toggle (close doors)"},
		{ID = "KRZDSet",			x=43.6+43*5, y=243, radius=20, tooltip="КУ10: Кнопка резервного закрытия дверей\nKRZD: Emergency door closing"},
	}
}
...
Metrostroi.ClientPropForButton("VUS",{
	panel = "Main",
	button = "VUSToggle",
	model = "models/metrostroi_train/Equipment/switch_3.mdl",
	ang = 180,
	z=4,
})

Metrostroi.ClientPropForButton("R_Program1",{
	panel = "Main",
...
Metrostroi.ClientPropForButton("ALSPl",{
	panel = "Main",
	button = "ALSPl",
	model = "models/metrostroi_train/81/plomb.mdl",
	z = 3,
...
Metrostroi.ClientPropForButton("PD",{
	panel = "Main",
	button = "PDToggle",
	model = "models/metrostroi_train/Equipment/switch_2.mdl",
	ang = 180,
...
Metrostroi.ClientPropForButton("PDPl",{
	panel = "Main",
	button = "PDPl",
	model = "models/metrostroi_train/81/plomb.mdl",
	z = 3,
...
ENT.ButtonMap["VU"] = {
	...
	buttons = {
		...
		{ID = "RezMKSet", x=0, y=210, w=50, h=110, tooltip="КУ15:Резервное включение мотор-компрессора\nREZ MK: Motor Compressor emergency toggle"},
...
ENT.ButtonMap["Tsepi"] = {
	...
	buttons = {
		...
		{x=0,y=0,w=85,h=50,tooltip="Напряжение батареи\nVoltage control circuits"},
	}
}
...
ENT.ButtonMap["AV2"] = {
	...
	buttons = {
		{ID = "RSTToggle", x=150, y=0, w=100, h=136, tooltip="РСТ: Радиооповещение и поездная радио связь\nRST: Radio warning and train radio communication"},
		{ID = "RSTPl", x=150+57, y=70, radius=60, tooltip="Пломба РСТ\nRST plomb"},
	}
}
...
ENT.ButtonMap["Back1"] = {
	...
	buttons = {
	{x=121, y=71, radius=50, tooltip="Тональное устройство АРС)\nRing device ARS"},
	{x=191, y=71, radius=50, tooltip="УЛСПМ (Уствойство связи пассажир-машинист)\nULSPM"},
	...
	--{ID = "R_ZSToggle",	x=-30, y=270, w=100, h=140, tooltip="РРИ: Питание РРИ\nRadioinformator control"},
	}
}
...
ENT.ButtonMap["AV3"] = {
	...
	buttons = {
		{ID = "R_RadioToggle", x=30, y=0, w=100, h=136, tooltip="+50В: Блок управления РРИ и ПНМ (Включение радиоинформатора)\n+50V: Radioinformator, RRI block "},
...
ENT.ButtonMap["UOS"] = {
	...
	buttons = {
			{ID = "UOSToggle", x=262, y=54, w=20, h=20, tooltip="УОС: Тумблер ограничителя скорости \nUOS"},
			{ID = "UOSPl", x=270, y=80, radius=30, tooltip="УОС Пломба\nUOS"},
	}
}
...
ENT.ButtonMap["KAH"] = {
	...
	buttons = {
			{ID = "KAHToggle", x=3, y=30, w=20, h=20, tooltip="ТАХ: Тумблер аварийного хода (КАХ) \n TAH"},
			{ID = "KAHPl", x=12, y=60, radius=30, tooltip="Пломба ТАХ\nPlomb TAH"},
	}
}
...
ENT.ButtonMap["RC1"] = {
	...
	buttons = {
			{ID = "RC1Toggle", x=0, y=0, w=100, h=300, tooltip="РЦР: Кулачковый разъединитель цепей АРС \nRCR"},
			{ID = "RC1Pl",x=50, y=100, radius=50, tooltip="Пломба РЦР\nRCR plomb"},
	}
}

ENT.ClientProps["RC1Pl"] = {
	model = "models/metrostroi_train/switches/autoplombr.mdl",
	pos = Vector(409.35,22.58,1.2),
	ang = Angle(0.000000,90,90.000000),
}
...
ENT.ButtonMap["AnnouncerDisplay"] = {
	pos = Vector(453.8+1+7.9,-35.4,29.29),
	ang = Angle(0,-97,110),
	width = 10,
	height = 10,
	scale = 0.008,
...
ENT.ButtonMap["IGLA"] = {
	pos = Vector(445.6,-50.985,12.9),
	ang = Angle(-0.5,180+45,90),
	width = 440,
	height = 100,
	scale = 0.014,
}
...
ENT.ClientProps["EPK_disconnect"] = {
	...
	pos = Vector(429.35,-52.78,-44.35),
	ang = Angle(90,90+10,0),
}
ENT.ClientProps["RC1"] = {
	model = "models/metrostroi_train/81-707/rcr.mdl",
	pos = Vector(408.35,24.48,-1.6),
	ang = Angle(0,0,0),
}
...
ENT.ClientProps["Ema_salon"] = {
	model = "models/metrostroi_train/81-707/81-707_salon.mdl",
	pos = Vector(0,0,0),
	ang = Angle(0,0,0)
}
...
ENT.ClientProps["speedo1"] = { 
	model = "models/metrostroi_train/81-707/big_digit.mdl", 
	pos = Vector(457.82,-40.1,-6.93),
	ang = Angle(96,0,0),
	color = Color(250,200,70),
}
ENT.ClientProps["speedo2"] = { 
	model = "models/metrostroi_train/81-707/big_digit_2.mdl", 
	pos = Vector(457.82,-40.1+0.89,-6.93),
	ang = Angle(96,0,0),
	color = Color(250,200,70),
}
...
ENT.ClientProps["door1"] = {
	model = "models/metrostroi_train/81-707/81-707_door_tor_ars.mdl",
...
function ENT:Think()
	...
	self:ShowHideSmooth("RedRP",self:Animate("RedRP_hs",self:GetPackedBool(35) and 1 or 0,0,1,3,false) + self:Animate("RedLSN_hs",self:GetPackedBool(131) and 1 or 0,0,0.4,2,false))
	self:ShowHideSmooth("Sequence",self:GetPackedBool("Sequence") and 1 or 0,0,1,5,false)
	
	self:ShowHideSmooth("VD",self:Animate("light_KVD",self:GetPackedBool(48) and 1 or 0,0,1,8,false))
	self:ShowHideSmooth("KT",self:Animate("light_KT",self:GetPackedBool(47) and 1 or 0,0,1,8,false))
	self:ShowHideSmooth("AB",self:Animate("**",self:GetPackedBool(56) and 0 or 1,0,1,8,false))
	
	self:ShowHideSmooth("Doors",self:Animate("Doors_hs",self:GetPackedBool(40) and 0 or 1,0,1,5,false))
	self:ShowHideSmooth("LN",self:Animate("light_LN",self:GetPackedBool("LN") and 1 or 0,0,1,15,false))
	self:ShowHideSmooth("Sbor",self:Animate("GreenRP_hs",self:GetPackedBool(131) and 1 or 0,0,0.7,8,false))

	
	---ARS 
	
	self:ShowHideSmooth("LNF",self:Animate("light_OCh",self:GetPackedBool(41) and 1 or 0,0,1,5,false))
	self:ShowHideSmooth("L0",self:Animate("light_0",self:GetPackedBool(42) and 1 or 0,0,1,5,false))
	self:ShowHideSmooth("L40",self:Animate("light_40",self:GetPackedBool(43) and 1 or 0,0,1,5,false))
	self:ShowHideSmooth("L60",self:Animate("light_60",self:GetPackedBool(44) and 1 or 0,0,1,5,false))
	self:ShowHideSmooth("L80",self:Animate("light_80",self:GetPackedBool(46) and 1 or 0,0,1,8,false))
	self:ShowHideSmooth("L70",self:Animate("light_70",self:GetPackedBool(45) and 1 or 0,0,1,6,false))
	...
	self:Animate("DoorSelect",		self:GetPackedBool("DoorSelect") and 1 or 0, 	0,1, 12, false)
	...
	self:Animate("KVT",				self:GetPackedBool(28) and 0 or 1, 	0,1, 16, false)
	
		----PD  | ARS
	self:Animate("ARS",				self:GetPackedBool(56) and 1 or 0, 	0,1, 16, false)
	--self:Animate("PD",				self:GetPackedBool("PD") and 1 or 0, 	0,1, 16, false)
	...
	self:Animate("R_Program1",		self:GetPackedBool(128) and 1 or 0, 0,1, 16, false)
	self:Animate("R_Program2",		self:GetPackedBool(129) and 1 or 0, 0,1, 16, false)
	...
	self:Animate("CustomC",			self:GetPackedBool(124) and 1 or 0, 0,1, 16, false)
		...
		---RCR ARS EZH ARS MP 
	self:Animate("RC1",				self:GetPackedBool(130) and 1 or 0, 	0,0.694, 6, false)
	
		---SCECIAL EZH ARS MP
	self:Animate("VAH",				self:GetPackedBool(10) and 0 or 1, 	0,1, 5, false)
	self:Animate("VAD",				self:GetPackedBool(11) and 1 or 0, 	0,1, 16, false) --IS NEEDED?
	self:Animate("UOS",				self:GetPackedBool(134) and 1 or 0, 	0,1, 5, false)

	self:Animate("BPS",				self:GetPackedBool(135) and 0 or 1, 	0,1, 5, false)
	...
	self:Animate("KAH",				self:GetPackedBool(163) and 1 or 0, 	0,1, 5, false)
	...
	self:SetCSBodygroup("ALSPl",1,self:GetPackedBool("ALSPl") and 0 or 1)
	self:HideButton("ALSToggle",self:GetPackedBool("ALSPl"))
	self:HideButton("ALSPl",not self:GetPackedBool("ALSPl"))
	self:SetCSBodygroup("PDPl",1,self:GetPackedBool("PDPl") and 0 or 1)
	self:HideButton("PD",self:GetPackedBool("PDPl"))
	self:HideButton("PDPl",not self:GetPackedBool("PDPl"))
	---EPK


	--- Чтобы лампы не загорались с выкл БВ!!!!!
	self:ShowHide("Doors",self:GetPackedBool(32))
	self:ShowHide("AB",self:GetPackedBool(32))
	self:ShowHide("KT",self:GetPackedBool(32))
	self:ShowHide("Sequence",self:GetPackedBool(32))
	...
	self:Animate("EPK_disconnect",self:GetPackedBool("EPK") and 1 or 0,0.25,0,  3,false)
	...
	self:Animate("voltmeter",		self:GetPackedRatio(7),				0, 0.096)
   ...
   -- self:Animate("speed1", 			self:GetPackedRatio("Speed") + math.sin(math.pi*8*self.Angle)*2/120,			0.495, 0.746,				nil, nil,  256,2,0.01)
	...
	if self.PreviousAlertState ~= state then
		...
		if state then
			self:SetSoundState("ring",0.1,1)
		else
			self:SetSoundState("ring",0,0)
			self:SetSoundState("ring_end",0,1.02)
			self:SetSoundState("ring_end",0.1,1.02)
		end
	end
