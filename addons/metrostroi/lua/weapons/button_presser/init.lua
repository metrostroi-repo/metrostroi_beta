...
--[[
hook.Add("OnEntityCreated","metrosrtoi_kostil",function(ent)
	if ent:GetClass():find("button") then print(ent,ent:GetSolid(),ent:GetSolidFlags()) end
	if ent:GetClass() == "momentary_rot_button" then
		timer.Simple(0,function() ent:SetSolidFlags(0) end)
	end
end)
]]
