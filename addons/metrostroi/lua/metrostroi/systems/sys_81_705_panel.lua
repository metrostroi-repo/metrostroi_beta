...
function TRAIN_SYSTEM:Initialize()
	...
	-- Выключатель батареи автоведения(ВБА)
	self.Train:LoadSystem("VBA","Relay","VB-11", {av3 = true})

	-- Buttons on the panel
	self.Train:LoadSystem("KVT","Relay","Switch", {button = true})
	self.Train:LoadSystem("VZP","Relay","Switch", {switch = true})
	self.Train:LoadSystem("VZD","Relay","Switch", {button = true})
	...
	self.Train:LoadSystem("Ring","Relay","Switch", {button = true})
	self.Train:LoadSystem("VUS","Relay","Switch", {switch = true})
	self.Train:LoadSystem("KAK","Relay","Switch", {button = true})
	self.Train:LoadSystem("VAutodrive","Relay","Switch", {switch = true})
	...
	self.Train:LoadSystem("VU","Relay","Switch", {normally_closed = true, av = true})
