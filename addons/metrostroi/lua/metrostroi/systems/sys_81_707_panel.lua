...
function TRAIN_SYSTEM:Initialize()
	...
	self.Train:LoadSystem("VB","Relay","VB-11", {av3 = true})

	-- Buttons on the panel
	self.Train:LoadSystem("DoorSelect","Relay","Switch", {krishka = true, normally_closed = false })
	self.Train:LoadSystem("DIPon","Relay","Switch", {vud = true})
	self.Train:LoadSystem("DIPoff","Relay","Switch", {vud = true})
	self.Train:LoadSystem("VozvratRP","Relay","Switch", {vud = true})
	...
	self.Train:LoadSystem("KDL","Relay","Switch", {vud = true})
	self.Train:LoadSystem("KDP","Relay","Switch", {vud = true})
	self.Train:LoadSystem("KRZD","Relay","Switch", {vud = true})
	self.Train:LoadSystem("KSN","Relay","Switch", {vud = true})
	...
	self.Train:LoadSystem("ALS","Relay","Switch", {switch = true, normally_closed = true })
	...
	self.Train:LoadSystem("R_UNch","Relay","Switch", {av = true, normally_closed = true})
	self.Train:LoadSystem("R_ZS","Relay","Switch", {av = true, normally_closed = true})
	self.Train:LoadSystem("R_G","Relay","Switch", {av = true, normally_closed = true})
	self.Train:LoadSystem("R_Radio","Relay","Switch", {av = true})
	self.Train:LoadSystem("R_Program1","Relay","Switch", {vud = true})
