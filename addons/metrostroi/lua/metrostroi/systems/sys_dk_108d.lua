--------------------------------------------------------------------------------
-- Тяговый электродвигатель постоянного тока (ДК-108Д)
--------------------------------------------------------------------------------
...
function TRAIN_SYSTEM:Think(dT)
	...
	self.RotationRate = self.RotationRate + 1.0 * (currentRotationRate - self.RotationRate) * dT
	...
	self.MagneticFlux13 = (Is13/320)*math.min(1.0,a+b*math.exp(-c*Is13/100))
	self.MagneticFlux24 = (Is24/320)*math.min(1.0,a+b*math.exp(-c*Is24/100))
