--------------------------------------------------------------------------------
-- Кулачковый контроллер КВ-40
--------------------------------------------------------------------------------
Metrostroi.DefineSystem("KV_40")
...
function TRAIN_SYSTEM:Inputs()
	return { "Enabled", "ControllerSet", "ReverserSet","Type",
			 ...
			 "SetX1", "SetX2", "SetX3", "Set0", "Set0Fast", "SetT1", "SetT1A", "SetT2","ControllerAutodriveSet" }
end

function TRAIN_SYSTEM:Outputs()
	return { "ControllerPosition","RealControllerPosition", "ReverserPosition", "ControllerPositionAutodrive" }
end
