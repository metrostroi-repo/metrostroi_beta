...
function TRAIN_SYSTEM:Initialize()
	...
	self.Train:LoadSystem("TormAT","Relay","Switch", {switch = true})
	...
	self.Train:LoadSystem("R_VPR","Relay","Switch", {switch = true})
	...
	self.Train:LoadSystem("Custom1","Relay","Switch",{button = true})
	self.Train:LoadSystem("Custom2","Relay","Switch",{button = true})
	self.Train:LoadSystem("Custom3","Relay","Switch",{button = true})
